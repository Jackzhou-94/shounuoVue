...
export default new Vuex.Store({
    state: {
        ...
        AddPricess:'http://192.168.1.199:8099/supplychain/craft/save',//工艺单保存接口
        PricessQueryPage:'http://192.168.1.199:8099/supplychain/craft/list',//工艺单分页查询接口
        PricessDetails:'http://192.168.1.199:8099/supplychain/craft/select',//工艺单详情数据
        delProce:'http://192.168.1.199:8099/supplychain/craft/delete',//删除工艺单信息
        ...
        addDispatch:'http://192.168.1.199:8099/supplychain/dispatch/add',//新增派工单
        dispatchPage:'http://192.168.1.199:8099/supplychain/dispatch/list',//派工单分页查询
        delFaDisp:'http://192.168.1.199:8099/supplychain/dispatch/delete',//删除派工单
        ...
        producelogDel:'http://192.168.1.199:8099/supplychain/producelog/delete',//生产日志删除
        upproducelog:'http://192.168.1.199:8099/supplychain/producelog/update',//修改生产日志

        addDelivProucts:'http://192.168.1.199:8099/supplychain/sendgoods/add',//半成品发货添加
        upDelivProucts:'http://192.168.1.199:8099/supplychain/sendgoods/save',//修改半成品发货
        selectSendgoods:'http://192.168.1.199:8099/supplychain/sendgoods/select',//根据id查询发货基本信息
        sendgoodsQueryPage:'http://192.168.1.199:8099/supplychain/sendgoods/list',//半成品发货分页查询
