<template>
    <div class="ProductionLog">
        ...
        >
            ...
            <el-table-column align="center" v-if="logCodeShow" label="生产日志编号" width="160px"></el-table-column>
            <el-table-column align="center" v-if="fatoryNameShow" label="工厂"></el-table-column>
            <el-table-column align="center" v-if="merchantCodeShow" label="商家编号" width="160px"></el-table-column>
            <el-table-column align="center" v-if="itemCodeShow" label="货品编号"></el-table-column>
            <el-table-column align="center" v-if="goodsNameShow" label="商品名称"></el-table-column>
            <el-table-column align="center" v-if="expectProduceQuantityShow" label="预计生产总量"
                             width="130px"></el-table-column>
            <el-table-column align="center" v-if="actualProduceQuantityShow" label="实际生产总量"
                             width="130px"></el-table-column>
            <el-table-column align="center" v-if="actualProduceTimeShow" label="实际生产时间" width="160px"></el-table-column>
            <el-table-column align="center" v-if="produceCodeShow" label="生产计划单编号" width="160px"></el-table-column>
            <el-table-column align="center" v-if="dispatchCodeShow" label="派工单号" width="160px"></el-table-column>
            <el-table-column align="center" v-if="applicantShow" label="填报人"></el-table-column>
            <el-table-column align="center" v-if="remarkShow" label="备注"></el-table-column>
        </el-table>
        <!--分页-->
        <el-row>
