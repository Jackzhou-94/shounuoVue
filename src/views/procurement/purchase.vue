    ...
    export default {
        ...
        methods: {
            ...
            updeltetPurchase(data) {
                //删除from表单数组中信息
                let a = this.upaddProcurementMater.goodsList.indexOf(data)
                this.upaddProcurementMater.goodsList.splice(a, 1)
                //     upgoodsMoney: 0,//总金额(不含税)
                //     uptaxgoodsMoney: 0,//总金额(含税)
                // goodsNum:0,//总数量,
                //     goodsMoney:0,//总金额
                ...
                this.upmatergoodsNum = this.upmatergoodsNum - data.number
            ...
            deltetmaterPurchase(data) {
                ...
                this.matergoodsNum = this.matergoodsNum - data.number
                this.matergoodsMoney = this.matergoodsMoney - (data.number * data.unitPrice)
                this.matertaxgoodsMoney = this.matertaxgoodsMoney - (data.number * data.taxPrice)
            },
            PreservationGoods() {
                //保存商品信息
